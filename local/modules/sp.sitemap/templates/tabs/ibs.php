...
?>
<?php
$pages = ModuleInterface::getIBlocks();
?>
<tr>
    <td>
        <table>
            ...
            <tr>
                <td class="adm-detail-content-cell-l">
                    <div class="wrapeer-button">
                        <div class="row-property-button" onclick="popupModal.showModal('Инфоблоки', 'ib')">Получить
                            Инфоблоки
                        </div>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input title="priority" class="custom-input" type="text" style="margin-top: 10px;width:70px"
                           name="ib[<?= $value['ID'] ?>][priority]" value="<?= $value['UF_PRIORITY'] ?>">
                </td>
                <td style="width:50px;">
                    <div onclick="popupModal.deleteStatic(this,  '<?= $value['ID'] ?>','#ibs_edit_table')"
                         class="row-property"
